package com.datafuturex.assistant.mcp.client;
...
import com.datafuturex.assistant.mcp.support.McpUpstreamCircuit;
...
public class McpUpstreamConnectionManager {
    ...
    private McpSyncClient openClient(AiMcpUpstreamEntity upstream) {
        ...
        try {
            ...
            markHealth(upstream.getId(), "DOWN", e.getMessage());
            throw new BusinessException("连接上游 MCP 失败: " + e.getMessage(), e);
        }
    }
