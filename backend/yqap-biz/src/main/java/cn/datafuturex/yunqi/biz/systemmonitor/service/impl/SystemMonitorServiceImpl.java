package cn.datafuturex.yunqi.biz.systemmonitor.service.impl;

import cn.datafuturex.yunqi.biz.systemmonitor.config.TableShardingProperties;
import cn.datafuturex.yunqi.biz.systemmonitor.dto.ApplicationMetricsDTO;
import cn.datafuturex.yunqi.biz.systemmonitor.dto.BusinessMetricsDTO;
import cn.datafuturex.yunqi.biz.systemmonitor.dto.ComponentHealthDTO;
import cn.datafuturex.yunqi.biz.systemmonitor.dto.DatabaseMetricsDTO;
import cn.datafuturex.yunqi.biz.systemmonitor.dto.JvmMetricsDTO;
import cn.datafuturex.yunqi.biz.systemmonitor.dto.OsMetricsDTO;
import cn.datafuturex.yunqi.biz.systemmonitor.dto.ShardingMetricsDTO;
import cn.datafuturex.yunqi.biz.systemmonitor.dto.ShardingStrategyMetricsDTO;
import cn.datafuturex.yunqi.biz.systemmonitor.dto.ShardingTableMetricsDTO;
import cn.datafuturex.yunqi.biz.systemmonitor.dto.StorageMetricsDTO;
...
import cn.datafuturex.yunqi.biz.systemmonitor.dto.WebServerMetricsDTO;
...
public class SystemMonitorServiceImpl implements SystemMonitorService {
    ...
    @Value("${spring.application.name:yqap}")
    private String applicationName;

    @Value("${yunqi.upload.path:uploads}")
    private String uploadPath;

    @Value("${logging.file.name:logs/yqap-backend.log}")
