package com.datafuturex.assistant.platform.ai;
...
public class AiConfig {
    ...
    private static final String SYSTEM_WITH_TOOLS = """
            ...
            - 「巡检计划」→ listInspectionPlans / getInspectionPlan
            - 「巡检任务」→ listInspectionTasks / getInspectionTaskDetail
            - 「巡检异常」→ listOpenInspectionIssues
