...
import cn.datafuturex.zhishu.testsupport.http.RecordingRestClient;
import cn.datafuturex.zhishu.testsupport.report.ApiTestRecorder;
import cn.datafuturex.zhishu.testsupport.report.ApiTestReportExtension;
...
@TestPropertySource(properties = {
        ...
        "jwt.secret=zhishu-api-it-secret-key-must-be-at-least-256-bits-long-for-hs256"
})
...
public abstract class ApiIntegrationTestBase {
    ...
    static void registerUploadPath(DynamicPropertyRegistry registry) {
        try {
            Path dir = Path.of(System.getProperty("java.io.tmpdir"), "zhishu-api-it-uploads");
