...
public class DocumentSchemaInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        try {
            ...
            populator.addScript(new ClassPathResource("archive/migration_rename_documents_to_knowledges.sql"));
            populator.addScript(new ClassPathResource("archive/migration_rename_document_category_to_knowledges_category.sql"));
            populator.addScript(new ClassPathResource("archive/migration_document_category.sql"));
