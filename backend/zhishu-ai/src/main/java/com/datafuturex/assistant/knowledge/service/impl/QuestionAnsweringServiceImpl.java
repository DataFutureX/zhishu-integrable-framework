...
import com.datafuturex.assistant.knowledge.service.QuestionAnsweringService;
...
public class QuestionAnsweringServiceImpl implements QuestionAnsweringService {
    ...
    private static String systemPrompt(String context) {
        return """
                ...
                %s
                """.formatted(
                com.datafuturex.assistant.knowledge.api.HybridRetrievalPort.KNOWLEDGE_CONTEXT_HEADER,
                context);
    }
