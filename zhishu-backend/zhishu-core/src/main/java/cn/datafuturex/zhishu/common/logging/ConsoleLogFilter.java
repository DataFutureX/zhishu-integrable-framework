package cn.datafuturex.zhishu.common.logging;
...
public class ConsoleLogFilter extends Filter<ILoggingEvent> {
    ...
    private static final List<String> INFO_LOGGER_PREFIXES = List.of(
            ...
            "cn.datafuturex.zhishu.YqapApplication",
            "cn.datafuturex.zhishu.config",
            "cn.datafuturex.zhishu.modules.controller.AuthController",
            "cn.datafuturex.zhishu.common.GlobalExceptionHandler"
    );
